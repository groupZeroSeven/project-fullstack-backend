...
export class Users1681571634616 implements MigrationInterface {
  name = "Users1681571634616";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "annoucements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "brand" character varying(50) NOT NULL, "banner" character varying NOT NULL, "model" character varying NOT NULL, "year" character varying(120) NOT NULL, "fuel" character varying NOT NULL, "mileage" integer NOT NULL, "color" character varying NOT NULL, "price" numeric(10,2) NOT NULL, "description" character varying NOT NULL, "is_bargain" boolean NOT NULL DEFAULT false, "is_published" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1df3f0c9b2c929d6586a0f405b3" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
